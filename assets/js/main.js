(function ($) {
  ...
  var swiper2 = new Swiper(".testi-content-slider", {
    loop: true,
    spaceBetween: 10,
    navigation: { nextEl: ".testi1-next", prevEl: ".testi1-prev" },
  ...
  var swiper = new Swiper(".blog-slider", {
    ...
    navigation: { nextEl: ".blog-next1", prevEl: ".blog-prev1" },
    breakpoints: {
  ...
  var mySwiper = new Swiper(".banner-center-slider", {
    ...
    mousewheel: true,
    breakpoints: {
      280: { slidesPerView: 3, navigation: false },
      386: { slidesPerView: 3, navigation: false },
  ...
  var swiper = new Swiper(".portfolio-slider-one", {
    ...
    pagination: { el: ".swiper-pagination", clickable: "true" },
    fadeEffect: { crossFade: true },
    navigation: { nextEl: ".portfolio-next1", prevEl: ".portfolio-prev1" },
    breakpoints: {
      280: { slidesPerView: 1, navigation: false },
      386: { slidesPerView: 1, navigation: false },
      576: { slidesPerView: 2, navigation: false },
  ...
  var lang = { html: "100%", css: "100%", javascript: "100%" };
  var multiply = 4;
