    ...
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-8 d-flex justify-content-lg-start justify-content-center flex-column">
                <h2 class="bread-crumb-title">Servicios</h2>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb gap-3 m-0 p-0">
                        <li class="breadcrumb-item"><a href="/">Inicio</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Más servicios</li>
                    </ol>
                </nav>
            </div>
            <div class="col-lg-4">
...
<div class="servcie-section pt-120">
    <div class="container-fluid">
        <div class="row justify-content-center gy-5">
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="service-single">
                    <div class="service-image">
                        <img src="/assets/images/bg/service-1.webp" alt="image">
                    </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="service-single">
                    <div class="service-image">
                        <img src="/assets/images/bg/service-3.webp" alt="image">
                    </div>
                    <div class="service-content">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="service-single">
                    <div class="service-image">
                        <img src="/assets/images/bg/service-4.webp" alt="image">
                    </div>
                    <div class="service-content">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="service-single">
                    <div class="service-image">
                        <img src="/assets/images/bg/service-2.webp" alt="image">
                    </div>
                    <div class="service-content">
