        ...
        <div class="row align-items-center g-4">
            <div class="col-lg-6">
                <div class="about-us-image">
                    <img src="/assets/images/banner/16.jpg" alt="image">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="about-us-content">
            ...
            <div class="col-lg-6">
                <div class="about-image-group d-flex flex-row
                    ...
                    <img width="340" src="/assets/images/banner/20.jpg" alt="image">
                    <img width="340" src="/assets/images/banner/19.jpg" class="d-xxl-block d-none" alt="image">
                </div>
            </div>
        </div>
    </div>
