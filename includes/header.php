        ...
        <ul class="menu-list" style="padding: 55px 0px;">
            ...
            <li class="menu-item-has-children menu-item">
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="/detail_photos">Familiar</a></li>
            ...
            <li class="menu-item-has-children menu-item">
                <a href="#" class="drop-down"> About</a><i class="bi bi-plus"></i>
                <ul class="sub-menu">
            ...
            <li class="menu-item-has-children menu-item">
                <a href="portfolio-column-four.html"> Portfolio</a><i class="bi bi-plus"></i>
                <ul class="sub-menu">
                    <li>
            ...
            <li class="menu-item-has-children menu-item">
                <a href="#" class="drop-down"> Pages</a><i class="bi bi-plus"></i>
                <ul class="sub-menu">
                    <li>
            ...
            <li class="menu-item-has-children menu-item">
                <a href="blog-grid-one.html">Blog</a><i class="bi bi-plus"></i>
                <ul class="sub-menu">
            ...
            <li class="menu-item-has-children menu-item">
                <a href="#" class="drop-down"> Contact</a><i class="bi bi-plus"></i>
                <ul class="sub-menu">
